...
public class JavaCompiler implements ClassReader.SourceCompleter {
    ...
    private static CompilePolicy DEFAULT_COMPILE_POLICY = CompilePolicy.BY_BEN;
...
//      System.err.println("completing " + c);//DEBUG
                        ...
                        Iterable<? extends Processor> processors)
    {
        ...
        try {
            ...
            // TODO Attributes type variables in Herrrr
            delegateCompiler = 
                processAnnotations(
                		enterTrees(stopIfError(CompileState.PARSE, parseFiles(sourceFileObjects))),
                    classnames);
            // TODO visits method defs here
    ...
    private void compile2() {
        try {
            ...
            case BY_BEN: {
            	// blg59 compiler policy. Minimal to do what I want
//            	System.out.printf("Compilers by Ben. (He's had a lot of help)\n");
            	Queue<Queue<Env<AttrContext>>> q = todo.groupByFile();
            	while (!q.isEmpty() && !shouldStop(CompileState.ATTR)) {
            		flow(attribute(q.remove()));
            	}
            	break;
            } 
