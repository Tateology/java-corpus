 ...
 *************************************************************************/
    ...
    void attribTypeVariables(List<JCTypeParameter> typarams, Env<AttrContext> env) {
    	for (JCTypeParameter tvar : typarams) {
            ...
            //blg59-
            //2013-08-06: Not logging here. 1. These are boring 2. no position
//            String msg = "";
//            if (boundStr != "") {
//            	msg = String.format("<Attr.attribTypeVariables>%s ==> [%s]</Attr.attribTypeVariables>\n",
//            			a, boundStr.substring(0, boundStr.length()-2));
//            } else {
//            	msg = String.format("<Attr.attribTypeVariables>%s ==> [%s]</Attr.attribTypeVariables>\n",
//                		a, "java.lang.Object");
//            }
//        	log.note(tree.pos(), "proc.messager", msg);  
            //-blg59
            a.tsym.flags_field &= ~UNATTRIBUTED;
        }
        for (JCTypeParameter tvar : typarams)
    ...
    public void visitMethodDef(JCMethodDecl tree) {
        ...
        try {
            ...
            for (List<JCTypeParameter> l = tree.typarams; l.nonEmpty(); l = l.tail) {
                ...
                // Collect the range for each type parameter. 
            	typeParamsStr += l.head.type.getLowerBound() + "-" +
            	    l.head.type.getUpperBound() + "; ";
            }
            ...
            chk.validate(tree.typarams, localEnv, Shapes.SHAPE.NOTOK);

            // Check that result type is well-formed.
            chk.validate(tree.restype, localEnv, Shapes.SHAPE.NOTOK);
        ...
        if (!typeParamsStr.equals("")) {
        	typeParamsStr = typeParamsStr.substring(0, typeParamsStr.length()-2);
        }
        //blg59
//        String msg = String.format("<Attr.visitMethodDef>%s %s {%s}",
//        		tree.sym, tree.restype, typeParamsStr);
//        log.note(tree.pos(), "proc.messager", msg);
        //-blg59
    }
    ...
    public void visitVarDef(JCVariableDecl tree) {
        ...
        chk.validate(tree.vartype, env, Shapes.SHAPE.NOTOK);
        deferredLintHandler.flush(tree.pos());
    ...
    public void visitApply(JCMethodInvocation tree) {
        ...
        // blg59: Validating method arguments. These cannot be shapes
        chk.validate(tree.typeargs, localEnv, Shapes.SHAPE.NOTOK);
    }
    //where
    ...
    public void visitNewClass(JCNewClass tree) {
        ...
        // blg59: instantiating a class here. `new XXX`. `clazz` is the `XXX`.
        chk.validate(clazz, localEnv, Shapes.SHAPE.NOTOK);
        if (tree.encl != null) {
        ...
        // blg59: validate type args for the CLASS, as in:
        // (NOTOK)    `new MyClass<T extends Comparable>`
        // (NOTOK) `new MyClass<T extends T<Comparable ... >`
        for (JCTree mytree : tree.typeargs) {
        	// debug prints
        	System.out.printf("TYPEARG %s\n", mytree.type);
        }
        chk.validate(tree.typeargs, localEnv, Shapes.SHAPE.NOTOK);
    }
    ...
    public void visitNewArray(JCNewArray tree) {
        ...
        if (tree.elemtype != null) {
            ...
            chk.validate(tree.elemtype, env, Shapes.SHAPE.NOTOK);
            owntype = elemtype;
    ...
    public void visitTypeCast(JCTypeCast tree) {
        ...
        chk.validate(tree.clazz, env, false, Shapes.SHAPE.NOTOK);
        //a fresh environment is required for 292 inference to work properly ---
        //see Infer.instantiatePolymorphicSignatureInstance()
        Env<AttrContext> localEnv = env.dup(tree);
        ...
        if (exprtype.constValue() != null) {
        	//blg59
//        	String msg = String.format("<Attr.visitTypeCast>%s ==> %s",
//        		exprtype, owntype);
//        	log.note(tree, "proc.messager", msg);
    ...
    public void visitTypeTest(JCInstanceOf tree) {
        ...
        //blg59 what is this? must be `instanceof`
        chk.validate(tree.clazz, env, false, Shapes.SHAPE.NOTOK);
            ...
            case TYP:
                ...
                if (owntype.tag == CLASS) {
                    ...
                    if (owntype.tsym.type.getTypeArguments().nonEmpty()) {
                        ...
                        //blg59: list the class + its type arguments (not logging because visitMethodDef handles this)
//                        String typeArgsStr = "";
//                        for (Object tt : (List<? extends Object>)owntype.tsym.type.getTypeArguments()) {
//                        	typeArgsStr += tt.toString() + "; ";
//                        }
//                        System.out.printf("<Attr.checkId:class>%s[%s]</Attr.checkId:class>\n",
//                                sym, typeArgsStr.substring(0, typeArgsStr.length()-2));
                    }
                    ...
                    // blg59: These are mostly identities, but I don't see where else to check fields
//                    String msg = String.format("<Attr.checkId:type>%s ==> %s",
//                    		sym, owntype);
//                    log.note(tree.pos(), "proc.messager", msg);
                }
                break;
            case VAR:
                ...
                //blg59
//                String tStr = owntype.toString();
//                if (!tStr.equals("java.lang.Object") && !tStr.equals("java.lang.String")){
//                	String msg = String.format("<Attr.checkId:var>%s === %s",
//                    		sym, owntype);
//                	log.note(tree.pos(), "proc.messager", msg);
//                }
                //-blg59
...
//            String msg = String.format("<Attr.checkInit>%s ==> %s",
//            		v, v.getConstValue());
//            log.note(tree.pos(), "proc.messager", msg);
            v.getConstValue(); // ensure initializer is evaluated
    ...
    void attribClass(ClassSymbol c) throws CompletionFailure {
        ...
        if ((c.flags_field & UNATTRIBUTED) != 0) {
            ...
            try {
                ...
                // blg59
//                chk.checkDeprecatedAnnotation(env.tree.pos(), c);a
            } finally {
                log.useSource(prev);
                chk.setLint(prevLint);
            }
    ...
    private void attribClassBody(Env<AttrContext> env, ClassSymbol c) {
        ...
        if (!c.isAnonymous()) {
        	...
        	// blg59: ok on the toplevel
            chk.validate(tree.typarams, env, Shapes.SHAPE.OK);
            // blg59 class C extends SHAPE is notok
            chk.validate(tree.extending, env, Shapes.SHAPE.OK);
            // blg59 class C implements SHAPE is notok (?)
            chk.validate(tree.implementing, env, Shapes.SHAPE.OK);
        }
