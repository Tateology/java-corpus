 ...
 *************************************************************************/
    ...
    public Env<AttrContext> classEnv(JCClassDecl tree, Env<AttrContext> env) {
        // blg59
        JCTree.Kind k = tree.getKind();
        // System.out.printf("Making classEnv for %s\n", tree.name.toString());
        if (k.equals(JCTree.Kind.INTERFACE)) {
          System.out.printf("Found new interface %s\n", tree.name.toString());
          ++this.numInterfaces;
        } else if (k.equals(JCTree.Kind.CLASS)) {
          System.out.printf("Found new class %s\n", tree.name.toString());
          ++this.numClasses;
        }
        // end blg59
...
//      System.err.println("entering " + c.fullname + " in " + c.owner);//DEBUG
    ...
    public void main(List<JCCompilationUnit> trees) {
        System.out.printf("Entering classes / interfaces...\n");
        this.numClasses = 0;
        this.numInterfaces = 0;
        complete(trees, null);
        String s = String.format("Finished entering. Found %d classes and %d interfaces (%d total)\n", this.numClasses, this.numInterfaces, this.numClasses + this.numInterfaces);
        System.out.printf(s);
    }
