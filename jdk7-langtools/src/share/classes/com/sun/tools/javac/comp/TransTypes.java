...
public class TransTypes extends TreeTranslator {
    ...
    JCExpression cast(JCExpression tree, Type target) {
        ...
        if (!types.isSameType(tree.type, target)) {
            ...
            // blg59 
//            String msg = String.format("<TransTypes.cast>%s ==> %s",
//        		    tree.type, target);
...
//        	System.out.printf("<TransTypes.translateArgs.a>%s ==> %s</TransTypes.translateArgs>\n",
//        		args.head, parameters.head);
        ...
        if (varargsElement != null) {
            while (args.nonEmpty()) {
//          		System.out.printf("<TransTypes.translateArgs.b>%s ==> %s</TransTypes.translateArgs>\n",
//               	    args.head, varargsElement);
