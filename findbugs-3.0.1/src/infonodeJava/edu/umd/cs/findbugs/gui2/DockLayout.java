...
public class DockLayout implements FindBugsLayoutManager {
    ...
    public javax.swing.JComponent getSourceViewComponent() { return null; }
...
//        }
    ...
    public void initialize() {
        ...
        //bg: could not find bugListPanel
        topView = new View(L10N.getLocalString("view.bugs", "Bugs"), null, null); //frame.bugListPanel());
