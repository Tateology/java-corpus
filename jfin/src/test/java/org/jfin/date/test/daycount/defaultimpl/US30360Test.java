...
public class US30360Test extends TestCase
{
	public void testShortPeriods() throws ParseException {
		...
		DaycountCalculator us30360 = DaycountCalculatorFactory.newInstance().getUS30360();

		assertTrue(us30360.calculateDaycountFraction(startDate, endDate)>0);
	}
}
