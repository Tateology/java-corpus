...
public class TestPeriod extends Period
{

	private int prototypeField = 0;

	public TestPeriod clone() {
		...
		period.setPrototypeField(getPrototypeField());
		return period;
	}


	public int getPrototypeField() {
		return prototypeField;
	}

	public void setPrototypeField(int prototypeField) {
