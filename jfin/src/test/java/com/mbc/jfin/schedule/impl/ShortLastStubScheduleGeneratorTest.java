 ...
 * Time: 17:35
 */
public class ShortLastStubScheduleGeneratorTest extends TestCase {
    public void testLongFirstStub() throws ScheduleException {
        ScheduleGenerator generator = new ShortLastStubScheduleGenerator();
        ...
        assertEquals(new LocalDate(2011,3,28), schedule.get(5).getStart() );
        assertEquals(new LocalDate(2011,4,28), schedule.get(5).getEnd() );
    }


    public void testGeneratorFail1() {
        ScheduleGenerator generator = new ShortLastStubScheduleGenerator(3);
