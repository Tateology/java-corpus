 ...
 * Time: 17:32
 */
public class LongLastStubScheduleGeneratorTest extends TestCase {

    public void testLongFirstStub() throws ScheduleException {
        ScheduleGenerator generator = new LongLastStubScheduleGenerator();
    ...
    public void testGeneratorFail1() {
        ScheduleGenerator generator = new LongLastStubScheduleGenerator(3);
