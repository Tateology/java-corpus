...
public class Actual366 extends DaycountCalculator
{

	private static Logger logger = Logger
			.getLogger("org.jfin.date.daycount.defaultimpl.Actual366");
			...
			Calendar endCalendar) throws DaycountException
	{
		...
		return daysBetween(startCalendar, endCalendar) / 366.0d;
	}
