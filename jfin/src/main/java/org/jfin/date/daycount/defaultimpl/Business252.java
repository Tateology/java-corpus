...
public class Business252 extends DaycountCalculator
{
	...
	private static Logger logger = Logger
			.getLogger("org.jfin.date.daycount.defaultimpl.Business252");

	private HolidayCalendar holidayCalendar = null;
			...
			Calendar endCalendar) throws DaycountException
	{
		...
		try
		{
			businessDays = holidayCalendar.getBusinessDaysBetween(
					startCalendar, endCalendar);
			return businessDays / 252.0d;
