 ...
 * Time: 15:34
 */
public class LongFirstStubScheduleGenerator extends AbstractBaseScheduleGenerator {


    public LongFirstStubScheduleGenerator() {
        super(-1);
    }

    public LongFirstStubScheduleGenerator(int maxPeriods) {
        super(maxPeriods);
    }
