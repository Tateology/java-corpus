...
public class ConfigurationDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ConfigurationDescriptor() {
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.Marshal");
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.Unmarshal");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setRequired(true);
        desc.setMultivalued(false);
