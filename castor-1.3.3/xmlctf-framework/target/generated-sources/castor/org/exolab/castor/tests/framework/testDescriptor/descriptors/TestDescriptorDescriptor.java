...
public class TestDescriptorDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TestDescriptorDescriptor() {
        ...
        desc.setImmutable(true);
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.types.CategoryType");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setRequired(true);
        desc.setMultivalued(false);
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.BugFix");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setValidator(fieldValidator);
        //-- _maximumJavaVersion
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Float.TYPE, "_maximumJavaVersion", "MaximumJavaVersion", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                TestDescriptor target = (TestDescriptor) object;
                if (!target.hasMaximumJavaVersion()) { return null; }
                return new java.lang.Float(target.getMaximumJavaVersion());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    // if null, use delete method for optional primitives 
                    if (value == null) {
                        target.deleteMaximumJavaVersion();
                        return;
                    }
                    target.setMaximumJavaVersion( ((java.lang.Float) value).floatValue());
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _maximumJavaVersion
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            org.exolab.castor.xml.validators.FloatValidator typeValidator;
            typeValidator = new org.exolab.castor.xml.validators.FloatValidator();
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.TestDescriptorChoice");
        desc.setHandler(handler);
