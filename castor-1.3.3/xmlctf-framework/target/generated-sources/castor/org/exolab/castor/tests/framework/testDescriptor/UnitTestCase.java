...
public class UnitTestCase implements java.io.Serializable {
     ...
     */
    private java.util.List _schemaDifferencesList;
    ...
    public UnitTestCase() {
        super();
        this._schemaDifferencesList = new java.util.ArrayList();
    ...
    throws java.lang.IndexOutOfBoundsException {
        ...
        this._schemaDifferencesList.add(vSchemaDifferences);
    }
    ...
    public java.util.Enumeration enumerateSchemaDifferences(
        ...
        return java.util.Collections.enumeration(this._schemaDifferencesList);
    }
    ...
    /**
     * Method iterateSchemaDifferences.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator iterateSchemaDifferences(
    ) {
        return this._schemaDifferencesList.iterator();
    }
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.exolab.castor.tests.framework.testDescriptor.UnitTestCase) org.exolab.castor.xml.Unmarshaller.unmarshal(org.exolab.castor.tests.framework.testDescriptor.UnitTestCase.class, reader);
    }
