...
public class UnitTestCaseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public UnitTestCaseDescriptor() {
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.UnitTestCaseChoice");
        desc.setHandler(handler);
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.CustomTest");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.Configuration");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.Failure");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.Listener");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setComponentType("org.exolab.castor.tests.framework.testDescriptor.SchemaDifferences");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
