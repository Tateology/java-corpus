...
public class TestDescriptor implements java.io.Serializable {
     ...
     * Field _commentList.
     */
    private java.util.List _commentList;
     ...
     */
    private float _maximumJavaVersion;

    /**
     * keeps track of state for field: _maximumJavaVersion
     */
    private boolean _has_maximumJavaVersion;
    ...
    public TestDescriptor() {
        super();
        this._commentList = new java.util.ArrayList();
    }
    ...
    /**
     */
    public void deleteMaximumJavaVersion(
    ) {
        this._has_maximumJavaVersion= false;
    }
    ...
    /**
     * Returns the value of field 'maximumJavaVersion'.
     * 
     * @return the value of field 'MaximumJavaVersion'.
     */
    public float getMaximumJavaVersion(
    ) {
        return this._maximumJavaVersion;
    }
    ...
    /**
     * Method hasMaximumJavaVersion.
     * 
     * @return true if at least one MaximumJavaVersion has been adde
     */
    public boolean hasMaximumJavaVersion(
    ) {
        return this._has_maximumJavaVersion;
    }
     ...
     * collection
     */
    public java.util.Iterator iterateComment(
    ) {
    ...
    /**
     * Sets the value of field 'maximumJavaVersion'.
     * 
     * @param maximumJavaVersion the value of field
     * 'maximumJavaVersion'.
     */
    public void setMaximumJavaVersion(
            final float maximumJavaVersion) {
        this._maximumJavaVersion = maximumJavaVersion;
        this._has_maximumJavaVersion = true;
    }
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.exolab.castor.tests.framework.testDescriptor.TestDescriptor) org.exolab.castor.xml.Unmarshaller.unmarshal(org.exolab.castor.tests.framework.testDescriptor.TestDescriptor.class, reader);
    }
