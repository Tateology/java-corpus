...
public class FailureType implements java.io.Serializable {
    ...
    public FailureType(final java.lang.String defaultValue) {
        try {
            setContent(new java.lang.Boolean(defaultValue).booleanValue());
         } catch(Exception e) {
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.exolab.castor.tests.framework.testDescriptor.FailureType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.exolab.castor.tests.framework.testDescriptor.FailureType.class, reader);
    }
