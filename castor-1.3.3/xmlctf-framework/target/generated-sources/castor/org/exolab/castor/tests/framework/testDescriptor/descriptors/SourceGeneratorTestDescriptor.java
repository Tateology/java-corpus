...
public class SourceGeneratorTestDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SourceGeneratorTestDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _sourcesNotExpected
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.exolab.castor.tests.framework.testDescriptor.SourcesNotExpected.class, "_sourcesNotExpected", "sourcesNotExpected", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                SourceGeneratorTest target = (SourceGeneratorTest) object;
                return target.getSourcesNotExpected();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SourceGeneratorTest target = (SourceGeneratorTest) object;
                    target.setSourcesNotExpected( (org.exolab.castor.tests.framework.testDescriptor.SourcesNotExpected) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.exolab.castor.tests.framework.testDescriptor.SourcesNotExpected();
            }
        };
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.SourcesNotExpected");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        //-- validation code for: _sourcesNotExpected
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
        ...
        desc.setSchemaType("list");
        desc.setComponentType("org.exolab.castor.tests.framework.testDescriptor.UnitTestCase");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setRequired(true);
        desc.setMultivalued(true);
