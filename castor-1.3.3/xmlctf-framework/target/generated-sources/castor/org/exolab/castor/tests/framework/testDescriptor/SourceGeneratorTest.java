...
public class SourceGeneratorTest implements java.io.Serializable {
     ...
     * Field _schemaList.
     */
    private java.util.List _schemaList;
     ...
     */
    private org.exolab.castor.tests.framework.testDescriptor.SourcesNotExpected _sourcesNotExpected;

    /**
     * A definition of a single Unit Test testcase.
     *  
     */
    private java.util.List _unitTestCaseList;
    ...
    throws java.lang.IndexOutOfBoundsException {
        this._unitTestCaseList.add(vUnitTestCase);
    }
    ...
    public java.util.Enumeration enumerateSchema(
        ...
        return java.util.Collections.enumeration(this._schemaList);
    }
    ...
    public java.util.Enumeration enumerateUnitTestCase(
        ...
        return java.util.Collections.enumeration(this._unitTestCaseList);
    }
    ...
    /**
     * Returns the value of field 'sourcesNotExpected'.
     * 
     * @return the value of field 'SourcesNotExpected'.
     */
    public org.exolab.castor.tests.framework.testDescriptor.SourcesNotExpected getSourcesNotExpected(
    ) {
        return this._sourcesNotExpected;
    }
    ...
    public java.util.Iterator iterateSchema(
        ...
        return this._schemaList.iterator();
    }

    /**
     * Method iterateUnitTestCase.
     * 
     * @return an Iterator over all possible elements in this
     * collection
     */
    public java.util.Iterator iterateUnitTestCase(
    ) {
        return this._unitTestCaseList.iterator();
    }
    ...
    /**
     * Sets the value of field 'sourcesNotExpected'.
     * 
     * @param sourcesNotExpected the value of field
     * 'sourcesNotExpected'.
     */
    public void setSourcesNotExpected(
            final org.exolab.castor.tests.framework.testDescriptor.SourcesNotExpected sourcesNotExpected) {
        this._sourcesNotExpected = sourcesNotExpected;
    }
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.exolab.castor.tests.framework.testDescriptor.SourceGeneratorTest) org.exolab.castor.xml.Unmarshaller.unmarshal(org.exolab.castor.tests.framework.testDescriptor.SourceGeneratorTest.class, reader);
    }
