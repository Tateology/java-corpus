...
public class TestDescriptorChoiceDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TestDescriptorChoiceDescriptor() {
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.SourceGeneratorTest");
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.MarshallingTest");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.SchemaTest");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setSchemaType("org.exolab.castor.tests.framework.testDescriptor.OnlySourceGenerationTest");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://castor.exolab.org/Test");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
