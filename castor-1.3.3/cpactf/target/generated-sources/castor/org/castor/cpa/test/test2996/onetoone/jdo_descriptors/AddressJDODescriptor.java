...
import org.castor.cpa.test.test2996.onetoone.Address;
 ...
 */
public class AddressJDODescriptor extends org.exolab.castor.mapping.loader.ClassDescriptorImpl {
    ...
    public AddressJDODescriptor() {
        ...
        jdoNature.setTableName("test2996_onetoone_address");
        setJavaClass(Address.class);
        jdoNature.setAccessMode(AccessMode.valueOf("shared"));
        jdoNature.addCacheParam("name", "org.castor.cpa.test.test2996.onetoone.Address");

        mapping.setAccess(ClassMappingAccessType.fromValue("shared"));
        mapping.setAutoComplete(true);
        mapping.setName("org.castor.cpa.test.test2996.onetoone.Address");
        mapping.setClassChoice(choice);
        mapTo.setTable("test2996_onetoone_address");
        ...
        try {
            Method idGetMethod = Address.class.getMethod("getId", null);
            Method idSetMethod = Address.class.getMethod("setId", new Class[]{
                long.class});
