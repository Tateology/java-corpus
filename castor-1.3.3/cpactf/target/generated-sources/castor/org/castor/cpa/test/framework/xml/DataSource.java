...
public class DataSource implements java.io.Serializable {
     ...
     * Field _paramList.
     */
    private java.util.List<org.castor.cpa.test.framework.xml.Param> _paramList;
    ...
    public DataSource() {
        super();
        this._paramList = new java.util.ArrayList<org.castor.cpa.test.framework.xml.Param>();
    }
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.castor.cpa.test.framework.xml.Param> enumerateParam(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends org.castor.cpa.test.framework.xml.Param> iterateParam(
    ) {
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.castor.cpa.test.framework.xml.DataSource) org.exolab.castor.xml.Unmarshaller.unmarshal(org.castor.cpa.test.framework.xml.DataSource.class, reader);
    }
