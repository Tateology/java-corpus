...
public class TableDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TableDescriptor() {
        ...
        //-- _accessMode
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(types.TableAccessModeType.class, "_accessMode", "accessMode", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Table target = (Table) object;
                    target.setAccessMode( (types.TableAccessModeType) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(types.TableAccessModeType.class, handler);
        desc.setImmutable(true);
