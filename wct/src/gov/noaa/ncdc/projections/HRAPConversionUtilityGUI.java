 ...
 * @author    steve.ansari
 */
public class HRAPConversionUtilityGUI implements ActionListener {
   ...
   public HRAPConversionUtilityGUI() {
      createGUI();
   }
   
   
   private void createGUI() {
      JFrame frame = new WCTFrame("HRAP Conversion Utility");
      ...
      String message = "<html>Directions:<br><br> "+
         "This will convert a WGS84 or NAD83 Shapefile <br>"+
         "into the HRAP Polar Stereographic projection.<br>"+
         "<br>"+
         "<br>"+
         "";
 ...
 // We can do this because the same border object can be reused.
   ...
   public static void main(String[] args) {
      HRAPConversionUtilityGUI util = new HRAPConversionUtilityGUI();
