...
public class HRAPRaster implements WCTRaster, WCTNativeRaster {
   ...
   private String longName = "HRAP Precipitation Grid";
   private String units = "kg m-2";
   private String standardName = "rainfall_amount";
   private String variableName = "HRAP_Precipitation";
...
//      raster = RasterFactory.createBandedRaster(DataBuffer.TYPE_FLOAT, WIDTH, HEIGHT, 1, null);
   ...
   public void init(DecodeNCRasterHeader header) throws java.io.IOException {
      ...
      double[] llcorner = header.getLLCorner();
