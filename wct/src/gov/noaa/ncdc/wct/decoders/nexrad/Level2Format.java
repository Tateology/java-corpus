...
// Constants
    ...
    */
   public final static int RECORD_HEADER_SIZE = 12;
   /**
    *  Description of the Field
    */
   public final static int FILE_HEADER_SIZE = 24;
   /**
    *  Description of the Field
    */
   public final static int RADAR_DATA_MSG_SIZE = 2432;
   /**
    *  Description of the Field
    */
   public final static int MAX_LEVEL2_RECORDS = 10000;

   /**
    *  Description of the Field
    */
   public final static int REFLECTIVITY = 0;
   /**
    *  Description of the Field
    */
    ...
    *  Description of the Field
    */
   public final static int SPECTRUM_WIDTH = 2;

   /**
    *  Description of the Field
    */
   public final static int SIGNAL_BELOW_THRESHOLD = 999;
   /**
    *  Description of the Field
    */
   public final static int SIGNAL_OVERLAID = 998;
   /**
    *  Description of the Field
    */
   public final static int DATA_NOT_FOUND = 997;

   /**
    *  Description of the Field
    */
   public final static int DOPPLER_RESOLUTION_LOW_CODE = 4;
   /**
    *  Description of the Field
    */
   public final static int DOPPLER_RESOLUTION_HIGH_CODE = 2;
   /**
    *  Description of the Field
    */
   public final static float DOPPLER_RESOLUTION_LOW = (float) 1.0;
   /**
    *  Description of the Field
    */
   public final static float DOPPLER_RESOLUTION_HIGH = (float) 0.5;

   /**
    *  Description of the Field
    */
   public final static int MAX_RADIALS_IN_CUT = 500;

   /**
    *  Description of the Field
    */
   public final static float HORIZONTAL_BEAM_WIDTH = (float) 1.5;

   /**
    *  Description of the Field
    */
   public final static float KM_PER_NM = (float) 1.85;
...
//-----------------------------------------------------------------------
    ...
    */
   public void read(URL nexrad_url, int start_flag) {
      ...
      try {
         ...
         try {
            ...
            System.out.println("**** OPENING: " + nexrad_url + " ::: " + din);
         } catch (Exception e) {
            e.printStackTrace();
            System.out.println("ERROR WITH URL: " + nexrad_url);
            return;
         }

         //System.out.println("-----" + nexrad_url + "-----");
         //System.out.println("\nLoading Data starting with record" +
         //      numberOfRecords + " Be patient!");
...
//      past midnight
         ...
         //System.out.println("File header julian date [" + julianDate +
         //      "] - seconds [" + seconds + "]");
...
//    MAX_LEVEL2_RECORDS.
         ...
         for (record = numberOfRecords; record < MAX_LEVEL2_RECORDS; record++) {
...
//        If a new elevation cut has started, update the cut LUT
               ...
               if (oldCut != getElevationNum()) {
                  ...
                  if (getElevationNum() > 0) {
                     ...
                     if (verbose) {
                        System.out.println("New cut --> " + getElevationNum() +
                           " at record " + record);
                     }
...
//            cuts to account for split cuts.
                     ...
                     if (verbose) {
                        System.out.println("dBZ bins [" + getBinNum(REFLECTIVITY) + "]");
                        System.out.println("Vel bins [" + getBinNum(VELOCITY) + "]");
                     }
...
//        record doesn't contain radar data.
               ...
               if (verbose) {
                  System.out.println("Message type " + getMessageType() + " detected");
               }
               azimuth[record] = -1;
               elevation[record] = -1;
         ...
         for (i = 0; i < MAX_RADIALS_IN_CUT; i++) {
            ...
            if (messageType == 1) {
               ...
               if (elevationNumber > oldElevationNumber) {
                  ...
                  System.out.println(i + " radials read in cut " + oldElevationNumber);
                  break;
               } else {
               ...
               if (verbose) {
                  System.out.println("Message type " + messageType + " found");
               }
...
//-----------------------------------------------------------------------
   ...
   public float getBinMoment(int moment, float azi, float ran) {
      ...
      System.out.println("Getting value for moment " + moment);
