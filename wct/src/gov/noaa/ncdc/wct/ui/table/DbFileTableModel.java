...
public class DbFileTableModel extends AbstractTableModel {
    ...
    public DbFileTableModel() throws SQLException, ClassNotFoundException, NumberFormatException, XPathExpressionException, SAXException, IOException, ParserConfigurationException {
    ...
    public void refresh() throws SQLException {
        String sqlQuery = "SELECT sr.SOURCE_ID, sr.DISPLAY_NAME, sr.PRODUCT_ID, sr.FILE_TYPE, ss.SOURCE_TYPE, ss.SOURCE, ss.DATETIME_ADDED, sr.URL "+
