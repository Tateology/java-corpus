...
public class SpcStormReportsUI extends JDialog {
	...
	private MapLayer hailReportsMapLayer;
...
//            @Override
    ...
    public void displayReports() throws Exception {
    	...
    	hailReportsMapLayer = stormReports.getMapLayer(yyyymmdd);
    	
    	viewer.getMarkerFeatures().addAll(hailReportsMapLayer.getFeatureSource().getFeatures().collection());
