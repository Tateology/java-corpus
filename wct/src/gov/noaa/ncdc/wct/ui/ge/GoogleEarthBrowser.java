...
public class GoogleEarthBrowser extends JPanel {
...
//    }
     ...
     */
    public GoogleEarthBrowser(int port, ViewController viewController, boolean includeStatusPanel, 
    ...
    public static void createFrame(final GoogleEarthBrowser geBrowser, final JFrame parent) {
...
//        return controlPanel;
    ...
    public void showLayersDialog(Frame parent) {
        ...
        jrb2dButton.setEnabled(ViewerKmzUtilities.isColladaCapable(viewer) || ! Double.isNaN(gridHeightInMeters));
        jrb3dButton.setEnabled(ViewerKmzUtilities.isColladaCapable(viewer) || ! Double.isNaN(gridHeightInMeters));
        jrbBothButton.setEnabled(ViewerKmzUtilities.isColladaCapable(viewer) || ! Double.isNaN(gridHeightInMeters));
        
        if (! ViewerKmzUtilities.isColladaCapable(viewer) && Double.isNaN(gridHeightInMeters)) {
        	jrb2dButton.setSelected(true);
        }
...
//        sb.append("             }                                                       \n");
        sb.append("         }                                                           \n");
//        sb.append("         if (ge.getFeatures().getChildNodes().getLength()) {                     \n");
//        sb.append("             ge.getFeatures().removeChild(ge.getFeatures().getLastChild());       \n");     
//        sb.append("             if (ge.getFeatures().hasChildNodes()) {                 \n");
//        sb.append("                 ge.getFeatures().removeChild(ge.getFeatures().getLastChild());   \n");     
//        sb.append("             }                                                       \n");
...
//        sb.append("         alert(ge.getFeatures().getChildNodes().getLength());    \n");
