...
/**
 *  Export features to csv text one feature at a time for low memory consumption.
 *
 * @author    steve.ansari
 */
public class StreamingCsvExport implements StreamingProcess {
     ...
     */
    public StreamingCsvExport(File outfile, String prj, FeatureType featureType) throws IOException {
     ...
     * @exception  IOException  Error when writing file?
     */
    public StreamingCsvExport(File outfile, String prj) throws IOException {
        this.outfile = outfile;
        this.prj = prj;
    }
     ...
     * @exception  IOException  Error when writing file?
     */
    public StreamingCsvExport(File outfile) throws IOException {
        this.outfile = outfile;
    ...
    private void csvInit(Feature exampleFeature) throws IOException {

        if (! outfile.toString().endsWith(".csv")) {
