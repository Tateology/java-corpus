...
public class TestExportRadialDatasetSweep {

    @Test
    public void testExportPoly() 
...
//      for (int n=0; n<varRef.getNumSweeps(); n++) {
        ...
        File outfile = new File("E:\\work\\export\\testRadialCDM-poly.shp");
        StreamingShapefileExport shpExport = new StreamingShapefileExport(outfile, WCTProjections.WGS84_WKT);
        ...
        decoder.decodeData(new StreamingProcess[] { streamingProcess, shpExport });
...
//      }
    ...
    @Test
    public void testExportPointAllSweeps() 
    throws InstantiationException, IOException, DecodeException, DecodeHintNotSupportedException, IllegalAccessException, ParseException {
...
//        decoder.setDecodeHint("endSweep", new Integer(0));
        ...
        decoder.setDecodeHint("attributes", DecodeRadialDatasetSweep.EXPORT_POINT_ATTRIBUTES);
        ...
        File outfile = new File("E:\\work\\export\\testRadialCDM-pointAllSweep.shp");
        StreamingShapefileExport shpExport = new StreamingShapefileExport(outfile, WCTProjections.WGS84_WKT);
...
//          for (int n=0; n<varRef.getNumSweeps(); n++) {
            ...
            File outfile = new File("E:\\work\\export\\testRadialCDM-point.shp");
            StreamingShapefileExport shpExport = new StreamingShapefileExport(outfile, WCTProjections.WGS84_WKT);
