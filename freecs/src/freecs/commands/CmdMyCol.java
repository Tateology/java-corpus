 ...
 * freecs.commands
 */
public class CmdMyCol extends AbstractCommand {
	private final String cmd= "/mycol";
	private final String version = "1.0";
	private static final ICommand selve=new CmdMyCol();
	...
	public boolean execute (MessageState msgState, String param) {
		if (isPunished (msgState)) 
			return false;
		msgState.msgTemplate = "message.mycol";
