 ...
 * freecs.commands
 */
public class CmdRepeatedPrivateMessage extends AbstractCommand {
	private final String cmd= "/";
	private final String version = "1.0";
	private static final ICommand selve=new CmdRepeatedPrivateMessage();

	private CmdRepeatedPrivateMessage () { }
	...
	public boolean execute (MessageState msgState, String param) {
        ...
        msgState.usercontext = msgState.sender.getPrivateUser ();
		if (msgState.usercontext == null) 
			return false;
		if (!msgState.usercontext.isLoggedIn ()) {
