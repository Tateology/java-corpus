...
public abstract class UDFunction extends AbstractFunction implements ScalarFunction
{
    ...
    {
        return value == null ? null : argDataTypes[argIndex].deserialize(value);//bg , ProtocolVersion.fromInt(protocolVersion));
    }
    ...
    {
        return value == null ? null : returnDataType.serialize(value);//bg , ProtocolVersion.fromInt(protocolVersion));
    }
