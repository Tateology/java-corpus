    ...
    @Test public void testLifecycleCanRecoverWithCustomComponentMonitor() throws NoSuchMethodException {
    	...
    	mockery.checking(new Expectations() {{
            ...
            one(cm).invoked(with(aNull(PicoContainer.class)),
                    with(aNull(ComponentAdapter.class)),
                    with(equal(Startable.class.getMethod("stop", (Class[])null))),
                    with(same(s1)), with(any(Long.class)), with(same((Float)null)), with(any(Object[].class)));
            // s2 expectations
            ...
            one(cm).invoked(with(aNull(PicoContainer.class)), with(aNull(ComponentAdapter.class)), with(equal(Startable.class.getMethod("start", (Class[])null))), with(same(s2)), with(any(Long.class)), with(same((Float)null)), with(any(Object[].class)));
            ...
            one(cm).invoked(with(aNull(PicoContainer.class)), with(aNull(ComponentAdapter.class)), with(equal(Startable.class.getMethod("stop", (Class[])null))), with(same(s2)), with(any(Long.class)), with(same((Float)null)), with(any(Object[].class)));
    	}});
